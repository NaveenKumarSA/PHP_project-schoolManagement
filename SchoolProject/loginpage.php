...
<div class="jumbotron bg-light,info  text-info text-right mt-0"><h1>login Page</h1>
     ...
     <div class=" container w-25 bg-info h-25 d-flex justify-content-center rounded-lg border border-white" style="padding: 105px; opacity: 0.8; margin: 80px " >
      <div  class="justify-content-center " style="margin-top: 20px" >
         <form action="submission.php" method="post">
            <input type="text" name="login_Name" placeholder="mail id / user name " class="rounded-sm border-white" style="padding: 9px; margin: 10px" >
          <input type="password" name="login_Password" placeholder="password " class="rounded-sm border-white" style="padding: 9px; margin: 10px" >
          <div class="d-flex justify-content-center">
            <input type="submit" name="submit" value="Signin" class=" text-white bg-info rounded-sm border-white" style="padding-top:3px; padding-left:13px; padding-bottom:3px; padding-right:13px;"><br>
        </div>
        <div class="buttons d-flex justify-content-center text-white"><a href="signuppage.php" class="text-white p-2">SignUp</a></div>
      </div>
    </div>
</div>
</body>
